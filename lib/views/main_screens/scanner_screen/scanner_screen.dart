...
Future<void> _saveQrCodeToGallery(GlobalKey key,BuildContext context) async {
  ...
  canvas.drawRect(
    Rect.fromLTWH(0, 0, image.width.toDouble() + padding * 2, image.height.toDouble() + padding * 2),
    paint,
  );
  ...
  ByteData? newByteData = await newImage.toByteData(format: ImageByteFormat.png);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RepaintBoundary(
                              key: _qrKey,
                              child: CustomPaint(
                                size: const Size(279.0, 279.0), // Set the size of the QR code
